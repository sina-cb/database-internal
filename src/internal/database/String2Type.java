...
/*******************************************************************************
 * This class provides a static method for converting a String into any type
...
class String2Type {
	 ...
	 * value. To facilitate comparing objects, type T must implement Comparable
	 * <T>. Ex: cons (Integer.class, "7") produces the integer 7.
	 * 
	 * @param clazz
	 *            the class for the type to be returned (e.g., Integer.class)
	 * @param value
	...
	/***************************************************************************
	 * The main method is for testing purposes only. Note, the result of
	 * comparing 7 < 11 depends if they are interpreted as Strings or Integers.
	 * 
	 * @param args
